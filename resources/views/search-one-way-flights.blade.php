...
<div class="Mobile_container__nNrIR" role="button" tabindex="0">
    <div class="Mobile_col__Bhq1t"><div class="Mobile_cities__gpFp_">
            @isset($request->onewaywherefrom){{$request->onewaywherefrom}}@endisset
        ...
        @isset($request->onewaywhereto){{$request->onewaywhereto}}@endisset
    </div>
    <div class="Mobile_details__stgqH">
            @isset($request->datetimes2)
            @php
            $date =$request->datetimes2;
            $formdate = date_create($date);
            if($formdate == ''){
                $formdate = date_create(date('Y-m-d', strtotime(' +1 day'))); 
            }
            // print_r($formdate == ''); exit ;
            @endphp 
            @endisset
            
        <span>{{date_format($formdate,"D, d M ")}}</span>
        ...
        <div class="modal-body">
            <div class="slider_tab">
                ...
                <div class="tab-content" id="pills-tabContent">
                                            ...
                                            <div
                                                ...
                                                <div class="HorizontalFlightSearch_col__f_ElC">
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker_mobile"
                                                        ...
                                                        <div class="Inputs_input__value__zMd_E"><span
                                                            class="startDate" id="startDate_mobile">6/13/2023</span>
                                                ...
                                                <div class="HorizontalFlightSearch_col__f_ElC">
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker_mobile"
                                                        ...
                                                        <div class="Inputs_input__value__zMd_E"><span
                                                            class="endDate"
                                                            id="endDate_mobile">6/13/2023</span>
                    ...
                    <div class="tab-pane fade active show" id="pills-profile-mobile" role="tabpanel"
                                    ...
                                    <div>
                                        ...
                                        <div
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0">
                                                        ...
                                                        <div class="Inputs_row__pnlIe onewaywherefromresult">
                                                            ...
                                                            <div class="Inputs_col__mZfV_">
                                                                ...
                                                                <div class="Inputs_input__value__zMd_E countryname">
                                                                    <span>@isset($request->onewaywherefrom)
                                                                        {{$request->onewaywherefrom}}
                                                                        @endisset</span></div>
    
                                                            </div>
    
                                                            <div class="Inputs_badge__pARWW">
                                                                @isset($request->onewaywherefrom_shortname)
                                                                {{$request->onewaywherefrom_shortname}}
                                                                @endisset</div>
    
                                                        </div>
    
                                                        <input readonly="">
                                                        <input type="hidden" name="onewaywherefrom"
                                                            value="@isset($request->onewaywherefrom){{$request->onewaywherefrom}}@endisset">
                                                        <input type="hidden" name="onewaywherefrom_shortname"
                                                            value="@isset($request->onewaywherefrom_shortname){{$request->onewaywherefrom_shortname}}@endisset">
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0">
                                                        ...
                                                        <div class="Inputs_row__pnlIe onewaywheretolist">
                                                            ...
                                                            <div class="Inputs_col__mZfV_">
                                                                ...
                                                                <div class="Inputs_input__value__zMd_E countryname">
                                                                    <span>@isset($request->onewaywhereto){{$request->onewaywhereto}}@endisset</span>
                                                                </div>
    
                                                            </div>
    
                                                            <div class="Inputs_badge__pARWW">
                                                                @isset($request->onewaywhereto_shortname){{$request->onewaywhereto_shortname}}@endisset
                                                            </div>
    
                                                        </div>
    
                                                        <input readonly="">
                                                        <input type="hidden" name="onewaywhereto"
                                                            value="@isset($request->onewaywhereto){{$request->onewaywhereto}}@endisset">
                                                        <input type="hidden" name="onewaywhereto_shortname"
                                                            value="@isset($request->onewaywhereto_shortname){{$request->onewaywhereto_shortname}}@endisset">
                                            ...
                                            <div
                                                ...
                                                <input type="text" name="datetimes2" class="datetimes2_mobile" value="@isset($request->datetimes2){{date_format($formdate,"d/m/Y")}}@endisset">
                                                ...
                                                <div class="HorizontalFlightSearch_col__f_ElC">
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker2_mobile"
                                                        ...
                                                        <div class="Inputs_input__value__zMd_E"><span
                                                                id="startDate2" class="startDate2">@isset($request->datetimes2){{date_format($formdate,"d/m/Y")}}@endisset</span>
                                                ...
                                                <div class="HorizontalFlightSearch_col__f_ElC">
                                                    ...
                                                    <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0"
                                                        ...
                                                        <div class="Inputs_input__value__zMd_E">
                                                            <span>@isset($request->adults){{$request->adults}}@endisset
                                                                Adult,  @if($request->cabin_class=='Business' ) {{'Business Class'}} @endif
                    ...
                    <div class="tab-pane fade" id="pills-contact-mobile" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <form action="{{route('search-flights-multiple-way')}}" method="get">
                            <input type="hidden" name="numberofFlights" value="2">
                            <div class="add_flight_mobile">
                                ...
                                <div
                                    ...
                                    <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date custome_data_time">
                                        ...
                                        <div class="HorizontalFlightSearch_col__f_ElC">
                                            ...
                                            <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker3_mobile"
                                                ...
                                                <div class="Inputs_input__value__zMd_E"><span
                                                        id="startDate3" class="startDate3">{{date('d/m/Y')}}</span>
                                    ...
                                    <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date custome_data_time">
                                        ...
                                        <div class="HorizontalFlightSearch_col__f_ElC">
                                            ...
                                            <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker4_mobile"
                                                ...
                                                <div class="Inputs_input__value__zMd_E"><span id="startDate4" class="startDate4">{{date('d/m/Y')}}</span>
                                ...
                                <div id="hide"
                                    class=" HorizontalFlightSearch_inner__v18wS HorizontalFlightSearch_inner--multi__Vjso_">
                                    ...
                                    <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date">
                                        ...
                                        <div class="HorizontalFlightSearch_col__f_ElC">
                                            ...
                                            <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker5_mobile"
                                                ...
                                                <div class="Inputs_input__value__zMd_E"><span id="startDate5" class="startDate5">{{date('d/m/Y')}}</span>
                                                    ...
                                                    <div class="Passengers_row__hDnMI">
                                                        ...
                                                        <div class="Passengers_picker__AweCF"><button type="button"
                                                            ...
                                                            <div class="Passengers_description__WNjFy"><span
                                                                    ...
                                                                    type="hidden" name="adults" id='adults' value='1'><span
                                ...
                                <div>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <input type="text" name="datetimes2" class="datetimes2" value="@isset($request->datetimes2){{date_format($formdate,"d/m/Y")}}@endisset">
            ...
            <div class="modal-body">
                <center> 
                    ...
                    <div class="owl_theme_img_slider">
                        <div class="owl-carousel owl-theme" id="owl_theme_img_1">
                            <div class="item">
                        ...
                        <div>
                            ...
                            <div class="FlightsLoading_text__VZ2BX">
                                <div class="FlightsLoading_airline__WEtXE">
                                        ...
                                        <span>
                                                with @isset($request->onewaywherefrom){{$request->onewaywherefrom}} @endisset<br /> 
                                                with  @isset($request->onewaywhereto){{$request->onewaywhereto}} @endisset<br />
                                                with @isset($request->onewaywherefrom){{$request->onewaywherefrom}} @endisset<br /> 
                                                with  @isset($request->onewaywhereto){{$request->onewaywhereto}} @endisset<br />
                                                with @isset($request->onewaywherefrom){{$request->onewaywherefrom}} @endisset<br /> 
                                                with  @isset($request->onewaywhereto){{$request->onewaywhereto}} @endisset<br />
...
<script>
    ...
    //     jQuery("#flight_details").click(function () {
...
<script>
    $(document).ready(function () {       
        var url = "{{route('search-flights-one-way-details')}}";
        $.ajax({
            url: url,
            data: {
                wherefrom: "{{$request->onewaywherefrom}}",
                wherefrom_shortname: "{{$request->onewaywherefrom_shortname}}",
                whereto: "{{$request->onewaywhereto}}",
                whereto_shortname: "{{$request->onewaywhereto_shortname}}",
                datetimes: `@php
if(isset($request->datetimes2)){
			if(date('Y-m-d', strtotime(' +1 day')) == date('Y-m-d', strtotime($request->datetimes2 .' +1 day')) ){
			$request->datetimes2 =  date('Y-m-d', strtotime($request->datetimes2 .' +1 day')) ;
            echo $request->datetimes2 ;
			}else{
                echo $request->datetimes2 ;
            }
		}
