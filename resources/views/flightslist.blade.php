                         ...
                         <div class="col-md-8">
                             ...
                             <div class="flights_filters_right">
                                ...
                                <div class="appendFlightDetails">
                                    ...
                                    <?php $defult = 0  ?>
                                    @foreach ($dataoftrip1['data'] as $key=>$item)                                    
                                   
                                    <?php

                                        $getTime  = explode(' ',$item['first_flight_data']['duration']); 
                                        ...
                                        // $getTime  = explode(' ',$item['second_flight_data']['duration']); 
                                        // $hours = (int)str_replace('h','',$getTime[0]);
                                        // $minutes = 0 ; 
                                        // if(count($getTime) == 2){
                                        //     $minutes = (int)str_replace('m','',$getTime[1]);
                                        // }
                                        // $onehourcount =  $minutes*(1/60) ; 
                                        // $secodetTimesum  = $hours + $onehourcount ; 
                                    ?>
                                    {{-- {{$firstTimesum + $secodetTimesum }} --}}
                                    <form data-defult ="{{$defult}}"  data-amount="{{ round($item['fare_original_amount'],2)}}" data-duration_time="{{$total_duration_minutes }}" action="{{route('booking_details')}}" method="get">
                                   
                                <input type="hidden" name="flight_details" value="{{  json_encode($item) }}">    
                                {{-- round trip --}}
...
<div   class="result_flights_details first_alliance_code_{{$item['first_flight_data']['allianceCodes']}}   second_flight_code_{{$item['second_flight_code']}}  first_flight_code_{{$item['first_flight_code']}}   first_flite_stop_{{$item['first_flight_data']['stopoverCode']}}  second_flite_stop_{{$item['second_flight_data']['stopoverCode']}}" >
        ...
        <div class="Result_flights__Z1D3s">
                    ...
                    <div class="Price_wrapper__HcyeP DefaultPriceWidget_wrapper__abddu DefaultPriceWidget_large__WCkvW">
                        ...
                        <div class="DefaultPriceWidget_price__TjRay">
                            ...
                            <div class="Price_inner__6srg_">
                                ...
                                <div><span class="Price_price__WtdgG withoutDiscountPrice" >{{$CurrencyCodeValue}} {{ round($item['withoutDiscountPrice'],2)}} </span> </div>
                                ...
                                <div class="PriceBreakdown_info__vReDL">
                                        <span class="Price_price__WtdgG" >{{$CurrencyCodeValue}} {{round($item['fare_original_amount'],2)}} </span>
                                </div>
    
                            </div>
    
                        </div>
                        <div class="Plaques_plaques__whgH6 DefaultPriceWidget_plaques__WLo4S" @if($key > 4) style="display: none;"   @endif>
            ...
            <div class="flight_city_to_ct">
                ...
                <div
                    ...
                    class="GroupSegmentHeader_group-segment__bYK_U GroupSegmentHeader_group-segment--large__otuDu">
    
                    <div class="GroupSegmentHeader_destinations__T_m3P">{{$request->wherefrom}}
                    ...
                    <div class="GroupSegmentHeader_right__J2Bpw">
                        ...
                        <div class="GroupSegmentHeader_date__vTEtc">{{$item['first_flight_data']['fromDate']}}</div>
                ...
                <div>    
                    <div>    
                        <div class="FlightLarge_container__16ya5 ">
                                <div class="FlightSmall_container__ux4g4 mobile-view-list">
                                        <div class="FlightSmall_details-row__yX5fq">
                                            <div class="AirlineLogos_container__kon63
                                                ...
                                                <div class="AirlineLogos_logos__lM3lx">
                                                    <div class="AirlineLogo_logo__RFs6c
                                                            ...
                                                            data="https://content.airhex.com/content/logos/airlines_{{ $item['first_flight_code'] }}_300_150_r.gif"
                                                            type="image/png"></object></div>
                                                </div>
                                                <div class="AirlineLogos_airline-string__TBSKu"
                                                    title="{{ $item['first_flight_name'] }}">
                                                    {{ $item['first_flight_name'] }}</div>
                                                    ...
                                                    <div class="Tooltip_row__hoTNN">
                                                        ...
                                                        <div>
                                                            <div class="Tooltip_title__iHHRq">
                                                                {{ $item['first_flight_name'] }}
                                                            </div>
                                                            @php
                                                                   $segmentsItem = '';  
                                                                @endphp
                                                                @foreach ($item['first_flight_data']['segments'] as $segmentsItem)                                                            
                                                                @php
                                            ...
                                            <div>
                                                <div>{{$item['first_flight_data']['fromtime']}} - {{$item['first_flight_data']['totime']}} </div>
                                                <div class="FlightSmall_small-text__CtatN">{{$item['first_flight_data']['segments'][0]->departureAirportCode}} - 
                                                    @if ((count($item['first_flight_data']['segments'])) >= 2)
                                                    @php 
                                                    $countSegments = count($item['first_flight_data']['segments']) - 1 ;
                                                    @endphp
                                                    {{$item['first_flight_data']['segments'][$countSegments]->arrivalAirportCode}}
                                                    @else                                                
                                                    {{$item['first_flight_data']['segments'][0]->arrivalAirportCode}}
                                                    @endif </div>
                                            </div>
                            ...
                            <div class="FlightLarge_inner__P5CEz">
                                ...
                                <div
                                    ...
                                    <div class="AirlineLogos_logos__lM3lx">
                                        ...
                                        <div
                                            ...
                                            <img src="https://content.airhex.com/content/logos/airlines_{{$item['first_flight_code']}}_300_150_r.gif" type="image/png" />
                                    ...
                                    <div class="AirlineLogos_airline-string__TBSKu"
                                        ...
                                        title="{{$item['first_flight_name']}}">{{$item['first_flight_name']}}
                                ...
                                <div class="Bookend_container__3qkC5">
                                    ...
                                    <div class="Bookend_date__O477p fromdata">
                                        ...
                                        {{$item['first_flight_data']['fromDate']}}
    
                                    </div>
    
                                    <div class="Bookend_time__Zjmyd fromtime">{{$item['first_flight_data']['fromtime']}}</div>
                                ...
                                <div class="Duration_container__t69p4">
                                    ...
                                    <div class="Duration_duration__SQZPm">
                                        ...
                                        <div class="Duration_text__0Ix3p">{{$item['first_flight_data']['duration']}}</div>
                                    ...
                                    <div class="Duration_text__0Ix3p">
                                        ...
                                        <div class="Duration_text-item__PFLDC formcode">{{$item['first_flight_data']['segments'][0]->departureAirportCode}}</div>
                                        ...
                                        <div
                                            ...
                                            <div class="Duration_tooltip-container__E7P58 ">
                                                ...
                                                <span class="stop_code">{{str_replace('_','-',$item['first_flight_data']['stopoverCode'])}}</span>
                                ...
                                <div class="Bookend_container__3qkC5">
                                    ...
                                    <div class="Bookend_date__O477p todate">
                                        ...
                                        {{$item['first_flight_data']['toDate']}}
    
                                    </div>
    
                                    <div class="Bookend_time__Zjmyd totime">{{$item['first_flight_data']['totime']}}</div>
                            ...
                            <div class="FlightLarge_right__ADJ_F FlightLarge_right__ADJ_F-mobile-one" >
                                    <div class="mobile-view-list">
                                        <div class="FlightSmall_col__7aeq1" style="left: 11px;">
                                            <div class="FlightSmall_info__BX8K4"><svg width="13" height="12" viewBox="0 0 13 12" fill="none"
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        ...
                                                        fill="#091A4B"></path>
                                                </svg>{{str_replace('_','-',$item['first_flight_data']['stopoverCode'])}}</div>
                                        </div>
                                        <div class="FlightSmall_col__7aeq1" style="left: 96px;">
                                                <div class="FlightSmall_info__BX8K4"><svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                                        ...
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                                            ...
                                                            fill="currentCOlor"></path>
                                                    </svg>{{$item['first_flight_data']['duration']}}</div>
                                        </div>
                                    </div>
                                <div class="FlightSmall_col__7aeq1 button" >
                                    <button id="flight_details" type="button" onclick="flightsdetailsHideshow('flight_one_{{$key}}')"
                        ...
                        <div class="FlightDetails_wrapper__UA7l2" id="flight_one_{{$key}}"
                            ...
                            <div class="FlightDetails_container__RZDm7">
                                ...
                                <div class="Header_header__IYteF">
                                    ...
                                    <div class="Header_cities__kj9SL">{{$request->wherefrom}}<svg
                                        ...
                                        </svg>{{$request->whereto}}</div>
    
                                    <div class="Header_eft__Flh6E">{{$item['first_flight_data']['duration']}}</div>
    
                                </div>                            
                                @foreach ($item['first_flight_data']['segments'] as $keysegmentsItem=>$segmentsItem)  
                                    ...
                                    <div class="FlightOverview_wrapper__Tdp7A FlightOverview_wrapper--large__lwzAp">
                                        ...
                                        <div class="FlightOverview_container__tdKDy">
                                            ...
                                            <div class="AirlineLogos_container__kon63">
                                                ...
                                                <div class="AirlineLogos_logos__lM3lx">
                                                    ...
                                                    <div
                                                        ...
                                                        <img src="https://content.airhex.com/content/logos/airlines_{{$item['first_flight_code']}}_300_150_r.gif" alt="">
                                                ...
                                                <div class="AirlineLogos_airline-string__TBSKu"
                                                    ...
                                                    title="{{$item['first_flight_name']}}">{{$item['first_flight_name']}} </div>
                                                    ...
                                                    <div class="Tooltip_row__hoTNN">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="AirlineLogo_logo__RFs6c">
                                                                ...
                                                                <img src="https://content.airhex.com/content/logos/airlines_{{$item['first_flight_code']}}_300_150_r.gif"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="Tooltip_title__iHHRq">{{$item['first_flight_name']}}
                                            ...
                                            <div>
                                                ...
                                                <div>{{$item['first_flight_name']}} - @if($segmentsItem->cabin=='business' ) {{'Business Class'}} @endif
                                                        @if($segmentsItem->cabin=='first' ) {{'First Class'}} @endif
                                                        @if($segmentsItem->cabin=='economy' ) {{'Economy'}} @endif
                                                        @if($segmentsItem->cabin=='premium_economy' ) {{'Premium Economy'}} @endif</div><small><span>
                                                   @php
                                ...
                                @if((count($item['first_flight_data']['segments'])-1) != $keysegmentsItem )
                                <div
        
                                class="custom-group-segment GroupSegmentHeader_group-segment--large__otuDu">
                
                                <div class="GroupSegmentHeader_destinations__T_m3P " style="color: red;font-size: 13px;font-weight: 500;"> {{ $item['first_flight_data']['stopoverDuration']}}
            ...
            <div class="flight_city_to_ct">
                    ...
                    <div
                        ...
                        <div class="GroupSegmentHeader_destinations__T_m3P"> {{$request->whereto}}
                        ...
                        <div class="GroupSegmentHeader_right__J2Bpw">
                            ...
                            <div class="GroupSegmentHeader_date__vTEtc">{{$item['second_flight_data']['fromDate']}}</div>
                    ...
                    <div>
                        ...
                        <div>        
                            <div class="FlightLarge_container__16ya5">
                                    ...
                                    <div class="FlightSmall_details-row__yX5fq">
                                        <div class="AirlineLogos_container__kon63
                                            ...
                                            <div class="AirlineLogos_logos__lM3lx">
                                                <div class="AirlineLogo_logo__RFs6c
                                                        AirlineLogos_logo__5vyxc"><object
                                                        data="https://content.airhex.com/content/logos/airlines_{{ $item['second_flight_code'] }}_300_150_r.gif"
                                                        type="image/png"></object></div>
                                            </div>
                                            <div class="AirlineLogos_airline-string__TBSKu"
                                                title="{{ $item['second_flight_name'] }}">
                                                {{ $item['second_flight_name'] }}</div>
                                            <div class="Tooltip_tooltip__ViBRq
                                                    AirlineLogos_tooltip__b_MPP">
                                                <div class="Tooltip_row__hoTNN">
                                                    <div>
                                                    ...
                                                    <div>
                                                        <div class="Tooltip_title__iHHRq">
                                                            {{ $item['second_flight_name'] }}
                                                        </div>
                                                        @php
                                                               $segmentsItem = '';  
                                                            @endphp
                                                            @foreach ($item['second_flight_data']['segments'] as $segmentsItem)                                                            
                                                            @php
                                                               $segmentsItem =$segmentsItem->designatorCode;  
                                                            @endphp
                                                            @endforeach
                                        ...
                                        <div>
                                            <div>{{$item['second_flight_data']['fromtime']}} - {{$item['second_flight_data']['totime']}} </div>
                                            <div class="FlightSmall_small-text__CtatN">{{$item['second_flight_data']['segments'][0]->departureAirportCode}} - 
                                                @if ((count($item['second_flight_data']['segments'])) >= 2)
                                                @php 
                                                $countSegments = count($item['second_flight_data']['segments']) - 1 ;
                                                @endphp
                                                {{$item['second_flight_data']['segments'][$countSegments]->arrivalAirportCode}}
                                                @else                                                
                                                {{$item['second_flight_data']['segments'][0]->arrivalAirportCode}}
                                                @endif </div>
                                        </div>
                                        <div class="FlightSmall_checkbox__IUdIf">                                           
                                            <input class="form-check-input" type="checkbox" name="exampleRadios" id="exampleRadios1" value="option1" checked="">
                                ...
                                <div class="FlightLarge_inner__P5CEz">
                                    ...
                                    <div
                                        ...
                                        <div class="AirlineLogos_logos__lM3lx">
                                            ...
                                            <div
                                                ...
                                                <img src="https://content.airhex.com/content/logos/airlines_{{$item['second_flight_code']}}_300_150_r.gif" type="image/png" />
                                        ...
                                        <div class="AirlineLogos_airline-string__TBSKu"
                                            ...
                                            title="{{$item['second_flight_name']}}">{{$item['second_flight_name']}}
                                    ...
                                    <div class="Bookend_container__3qkC5">
                                        ...
                                        <div class="Bookend_date__O477p fromdata">
                                            ...
                                            {{$item['second_flight_data']['fromDate']}}
        
                                        </div>
        
                                        <div class="Bookend_time__Zjmyd fromtime">{{$item['second_flight_data']['fromtime']}}</div>
                                    ...
                                    <div class="Duration_container__t69p4">
                                        ...
                                        <div class="Duration_duration__SQZPm">
                                            ...
                                            <div class="Duration_text__0Ix3p">{{$item['second_flight_data']['duration']}}</div>
                                        ...
                                        <div class="Duration_text__0Ix3p">
                                            ...
                                            <div class="Duration_text-item__PFLDC formcode">{{$item['second_flight_data']['segments'][0]->departureAirportCode}}</div>
                                            ...
                                            <div
                                                ...
                                                <div class="Duration_tooltip-container__E7P58 ">
                                                    ...
                                                    <span class="stop_code">{{str_replace('_','-',$item['second_flight_data']['stopoverCode'])}}</span>
                                    ...
                                    <div class="Bookend_container__3qkC5">
                                        ...
                                        <div class="Bookend_date__O477p todate">
                                            ...
                                            {{$item['second_flight_data']['toDate']}}
        
                                        </div>
        
                                        <div class="Bookend_time__Zjmyd totime">{{$item['second_flight_data']['totime']}}</div>
                                ...
                                <div class="FlightLarge_right__ADJ_F  FlightLarge_right__ADJ_F-mobile">
                                    <div class="mobile-view-list">
                                    <div class="FlightSmall_col__7aeq1" style="left: 11px;">
                                        <div class="FlightSmall_info__BX8K4"><svg width="13" height="12" viewBox="0 0 13 12" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                                    d="M5.29.533a2.075 2.075 0 00-.505 3.26L3.709 5.46 2.407 7.568a2.075 2.075 0 101.862 2.55l3.96.004a2.075 2.075 0 10.002-.958l-3.96-.003a2.077 2.077 0 00-.927-1.287l1.175-1.902 1.07-1.66a2.075 2.075 0 10-.3-3.778zm.01 2.356a1.117 1.117 0 111.963-1.068A1.117 1.117 0 015.301 2.89zm-4.03 7.283a1.117 1.117 0 111.962-1.069 1.117 1.117 0 01-1.963 1.069zm8.446-1.509a1.117 1.117 0 101.068 1.963 1.117 1.117 0 00-1.068-1.963z"
                                                    fill="#091A4B"></path>
                                            </svg>{{str_replace('_','-',$item['second_flight_data']['stopoverCode'])}}</div>
                                    </div>
                                    <div class="FlightSmall_col__7aeq1" style="left: 96px;">
                                            <div class="FlightSmall_info__BX8K4"><svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                                        d="M8.75 2.167a5.833 5.833 0 100 11.666 5.833 5.833 0 000-11.666zM3.917 8a4.833 4.833 0 119.666 0 4.833 4.833 0 01-9.666 0z"
                                                        fill="currentCOlor"></path>
                                                </svg>{{$item['second_flight_data']['duration']}}</div>
                                    </div>
                                    </div>
                                    <div class="FlightSmall_col__7aeq1 button" >  
                                    <button id="flight_details" type="button" onclick="flightsdetailsHideshow('flight_second_{{$key}}')"
                            ...
                            <div class="FlightDetails_wrapper__UA7l2" id="flight_second_{{$key}}"
                                ...
                                <div class="FlightDetails_container__RZDm7">
                                    ...
                                    <div class="Header_header__IYteF">
                                        ...
                                        <div class="Header_cities__kj9SL">{{$request->whereto}}<svg
                                            ...
                                            </svg>{{$request->wherefrom}}</div>
        
                                        <div class="Header_eft__Flh6E">{{$item['second_flight_data']['duration']}}</div>
        
                                    </div>
        
                                    @foreach ($item['second_flight_data']['segments'] as $keysegmentsItem=>$segmentsItem)
                                    {{-- @php
                                  echo '<pre>'; print_r($segmentsItem->durationMinutes); exit ;     
                                    @endphp --}}
                                    <div class="Flight_wrapper__O4_en Flight_wrapper--large__3Wrew">
                                        ...
                                        <div class="FlightOverview_wrapper__Tdp7A FlightOverview_wrapper--large__lwzAp">
                                            ...
                                            <div class="FlightOverview_container__tdKDy">
                                                ...
                                                <div class="AirlineLogos_container__kon63">
                                                    ...
                                                    <div class="AirlineLogos_logos__lM3lx">
                                                        ...
                                                        <div
                                                            ...
                                                            <img src="https://content.airhex.com/content/logos/airlines_{{$item['second_flight_code']}}_300_150_r.gif" alt="">
                                                    ...
                                                    <div class="AirlineLogos_airline-string__TBSKu"
                                                        ...
                                                        title="{{$item['second_flight_name']}}">{{$item['second_flight_name']}} </div>
                                                        ...
                                                        <div class="Tooltip_row__hoTNN">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirlineLogo_logo__RFs6c">
                                                                    ...
                                                                    <img src="https://content.airhex.com/content/logos/airlines_{{$item['second_flight_code']}}_300_150_r.gif"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="Tooltip_title__iHHRq">{{$item['second_flight_name']}}
                                                ...
                                                <div>
                                                    ...
                                                    <div>{{$item['second_flight_name']}} - 
                                                            @if($segmentsItem->cabin=='business' ) {{'Business Class'}} @endif
                                                            @if($segmentsItem->cabin=='first' ) {{'First Class'}} @endif
                                                            @if($segmentsItem->cabin=='economy' ) {{'Economy'}} @endif
                                ...
                                @if((count($item['second_flight_data']['segments'])-1) != $keysegmentsItem )
                                        <div
                
                                        class="custom-group-segment GroupSegmentHeader_group-segment--large__otuDu">
                        
                                        <div class="GroupSegmentHeader_destinations__T_m3P " style="color: red;font-size: 13px;font-weight: 500;"> {{ $item['second_flight_data']['stopoverDuration']}}
