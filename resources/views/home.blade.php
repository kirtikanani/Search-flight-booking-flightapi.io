                ...
                <div class="table-responsive">
                    <table class="table table-actions-bar m-b-0">
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/admin/images/products/iphone.jpg') }}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/admin/images/products/samsung.jpg') }}" class="thumb-sm pull-left m-r-10" alt=""> Samsung Phone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/admin/images/products/imac.jpg') }}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/admin/images/products/macbook.jpg') }}" class="thumb-sm pull-left m-r-10" alt=""> Apple iPhone </td>
                        ...
                        <tr>
                            ...
                            <td><img src="{{ asset('assets/admin/images/products/lumia.jpg') }}" class="thumb-sm pull-left m-r-10" alt=""> Lumia iPhone </td>
                            <td><span class="text-success">+$230</span></td>
                            <td>
                                <a href="#" class="table-action-btn"><i class="md md-edit"></i></a>
                                <a href="#" class="table-action-btn"><i class="md md-close"></i></a>
