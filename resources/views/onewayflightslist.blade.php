...
<div class="MobileFilters_wrapper__SZEi_">
                                ...
                                foreach($dataoftrip1['data_filter']->airlines as $filter_key=>$filter_val){
                                 ...
                                 <div class="asiana_all_flights">
                                     ...
                                     <div class="flights_title_img">
                                         ...
                                         <p><?php if(isset($filter_val->price->originalAmount)){echo $CurrencyCodeValue.' '.round($filter_val->price->originalAmount,2);}?></p>
                             ...
                             <div class="col-md-4">
                                 ...
                                 <div class="flights_filters_inner">
                                     ...
                                     <div class="filters_overlay ">
                                            ...
                                            <h4>Showing <span id="fiter-count-value">{{$countingTrip}}</span> results</h4>
                             ...
                             <div class="col-md-8">
                                ...
                                <a href="#" class="quickSort_item defult">
                                     ...
                                     <a href="#" class="quickSort_item cheapest">
                                        ...
                                        <div class="quickSort_item_info">     
                                            <h4> @isset($dataoftrip1['minPrice']['amount']) {{$dataoftrip1['minPrice']['amount'],2}} @endisset</h4>
                                     ...
                                     <a href="#" class="quickSort_item quickest">
                                         ...
                                         <div class="quickSort_item_info">
                                            ...
                                            <h4>@isset($dataoftrip1['tripDurations']['amount']){{$dataoftrip1['tripDurations']['amount'],2}} @endisset</h4>
                                    ...
                                    ?>
                                    <form data-defult ="{{$defult}}"  data-amount="{{round($item['fare_original_amount'],2)}}" data-duration_time="{{$firstTimesum}}" action="{{route('booking_details')}}" method="get">
                                        @csrf
                                    <input type="hidden" name="flight_details" value="{{  json_encode($item) }}">                  
                                           {{-- one - way  trip --}}
                                <input type="hidden" name="trip" value="2"> 
                                <?php
    ...
    <div class="result_flights_details   first_alliance_code_{{$item['first_flight_data']['allianceCodes']}} first_flight_code_{{$item['first_flight_code']}}   first_flite_stop_{{$item['first_flight_data']['stopoverCode']}}  " >
                            ...
                            <div class="FlightLarge_container__16ya5">
                                ...
                                <div class="FlightLarge_right__ADJ_F FlightLarge_right__ADJ_F-mobile-one">
                                        <div class="mobile-view-list">
                                                <div class="FlightSmall_col__7aeq1" style="left: 11px; width: 38%;bottom: 0px;">
                                                ...
                                                <div class="FlightSmall_col__7aeq1" style="left: 96px; width: 38%;bottom: 0px;">
                                            ...
                                            <div class="FlightSmall_col__7aeq1 button"  style="bottom: -11px !important;">
