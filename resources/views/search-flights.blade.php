...
<div class="Mobile_container__nNrIR" role="button" tabindex="0">
    <div class="Mobile_col__Bhq1t"><div class="Mobile_cities__gpFp_">
            @isset($request->wherefrom){{$request->wherefrom}}@endisset
        ...
        @isset($request->whereto){{$request->whereto}}@endisset
    </div>
    <div class="Mobile_details__stgqH">
            @isset($request->datetimes)
            @php
            $date = explode(' - ',$request->datetimes);
            $formdate = date_create($date[0]);
            $todate = date_create($date[1]);
            @endphp
            @endisset
        <span>{{date_format($formdate,"D, d M ")}}<span>-  {{date_format($todate,"D, d M ")}}</span></span>
         • <span>@isset($request->adults){{$request->adults}}@endisset Adult,  @if($request->cabin_class=='Business' ) {{'Business Class'}} @endif
                @if($request->cabin_class=='First' ) {{'First Class'}} @endif
                @if($request->cabin_class=='Economy' ) {{'Economy'}} @endif
                @if($request->cabin_class=='Premium_Economy' ) {{'Premium Economy'}} @endif /Coach</span>
        </div>
    </div>
        ...
        <div class="modal-body">
                        <div class="slider_tab">
                            ...
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    ...
                                    <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill"
                                        data-bs-target="#pills-home-mobile" type="button" role="tab" aria-controls="pills-home"
                                        aria-selected="true">Round-trip</button>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="tab-pane fade active show" id="pills-home-mobile" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form action="{{route('search-flights')}}" id="round_trip_search_submit" method="get">
                                        <div class="round-trip-error">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="HorizontalFlightSearch_col__f_ElC">
                                                                ...
                                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0">
                                                                    ...
                                                                    <div class="Inputs_row__pnlIe Wherefromresult ">
                                                                        ...
                                                                        <div class="Inputs_col__mZfV_">
                                                                            ...
                                                                            <div class="Inputs_input__value__zMd_E countryname">
                                                                                <span>@isset($request->wherefrom){{$request->wherefrom}}@endisset
                                                                                </span>
                                                                            </div>
                                                                        ...
                                                                        <div class="Inputs_badge__pARWW">
                                                                            @isset($request->wherefrom_shortname)
                                                                            {{$request->wherefrom_shortname}}
                                                                            @endisset
                                                                        </div>
                                                                    ...
                                                                    <input readonly="">
                                                                    <input type="hidden" name="wherefrom"
                                                                        value="@isset($request->wherefrom){{$request->wherefrom}}@endisset">
                                                                    <input type="hidden" name="wherefrom_shortname"
                                                                        value="@isset($request->wherefrom_shortname){{$request->wherefrom_shortname}}@endisset">
                                                                </div>
                
                                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                                    style="max-width: 500px; opacity: 1; transform: translate(0px, 0px); 
                                                                   @if(isset($request->wherefrom_shortname))
                                                                    display: none;
                                                                    @else
                                                                    display: block;
                                                                    @endif
                                                                    ">
                                                <div class="round-trip-error">Please enter where from</div>
                                                                    <div>
                                                                        ...
                                                                        <div class="AirportField_airport-search__X9tnw">
                                                                            ...
                                                                            <input class="Input_input__LYUld AirportField_input__C0fpS wherefrom_mobile"
                                                                                value="@isset($request->wherefrom_shortname){{preg_replace('/\s+/', '',$request->wherefrom_shortname)}}@endisset"
                                                                ...
                                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0">
                                                                    ...
                                                                    <div class="Inputs_row__pnlIe Wheretolist ">
                                                                        ...
                                                                        <div class="Inputs_col__mZfV_">
                                                                            ...
                                                                            <div class="Inputs_input__value__zMd_E countryname">
                                                                                <span>@isset($request->whereto){{$request->whereto}}@endisset</span>
                                                                            </div>
                
                                                                        </div>
                
                                                                        <div class="Inputs_badge__pARWW">
                                                                            @isset($request->whereto_shortname){{$request->whereto_shortname}}@endisset
                                                                        </div>
                
                                                                    </div>
                
                                                                    <input readonly="">
                                                                    <input type="hidden" name="whereto"
                                                                        value="@isset($request->whereto){{$request->whereto}}@endisset">
                                                                    <input type="hidden" name="whereto_shortname"
                                                                        value="@isset($request->whereto_shortname){{$request->whereto_shortname}}@endisset">
                                                                ...
                                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="AirportField_airport-search__X9tnw">
                                                                            ...
                                                                            <input class="Input_input__LYUld AirportField_input__C0fpS whereto_mobile"
                                                                                value="@isset($request->whereto_shortname){{ preg_replace('/\s+/', '',$request->whereto_shortname)}}@endisset"
                                                        ...
                                                        <div
                                                            ...
                                                            <input type="text" name="datetimes" id="e5" class="datetimes_mobile"
                                                                value="@isset($request->datetimes){{$request->datetimes}}@endisset">
                                                            </div>
                                                            <div class="HorizontalFlightSearch_col__f_ElC">
                                                                ...
                                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker_mobile"
                                                                    ...
                                                                    <div class="Inputs_input__value__zMd_E"><span class="startDate"
                                                                            id="startDate_mobile">@isset($date[0]){{$date[0]}}@endisset</span>
                                                            ...
                                                            <div class="HorizontalFlightSearch_col__f_ElC">
                                                                ...
                                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker_mobile"
                                                                    ...
                                                                    <div class="Inputs_input__value__zMd_E "><span class="endDate"
                                                                            id="endDate_mobile">@isset($date[1]){{$date[1]}}@endisset</span>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="HorizontalFlightSearch_col__f_ElC"><button
                                                                    class="HorizontalFlightSearch_submit__Pwl4r" id="round_trip_search_page" type="submit" >Search
                                ...
                                <div class="tab-pane fade" id="pills-profile-mobile" role="tabpanel" aria-labelledby="pills-profile-tab">
                                    <form action="{{route('search-flights-one-way')}}" id="oneway_trip_search_submit" method="get">
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                                ...
                                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="AirportField_airport-search__X9tnw">
                                                                            ...
                                                                            <input class="Input_input__LYUld AirportField_input__C0fpS onewaywherefrom_mobile"
                                                                ...
                                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <div class="AirportField_airport-search__X9tnw">
                                                                            ...
                                                                            <input class="Input_input__LYUld AirportField_input__C0fpS onewaywhereto_mobile"
                                                        ...
                                                        <div
                                                                        ...
                                                                        <div class="Passengers_container__GLqfw">
                                                                            ...
                                                                            <div class="Passengers_row__hDnMI">
                                                                                ...
                                                                                <div class="Passengers_picker__AweCF"><button
                                                                                    ...
                                                                                    <div class="Passengers_description__WNjFy"><span
                                                                                        ...
                                                                                        <input type="hidden" class="adults_oneway_trip_search_page" name="adults" id='adults'
                                                                                            value='1'>
                                                                                        <span class="Passengers_age__Bbl89"> (12+)
                                                                                        </span>
                                                                                    </div><input
                                                                                        class="Passengers_input__PbNMU quantity__input"
                                                                            ...
                                                                            <div class="Passengers_row__hDnMI">
                                                                                ...
                                                                                <div class="Passengers_picker__AweCF"><button
                                                                                    ...
                                                                                    <div class="Passengers_description__WNjFy"><span
                                                                                        ...
                                                                                        <input type="hidden" class="children_oneway_trip_search_page" name="children"
                                                                                            id='children' value='0'><span
                                                                                            class="Passengers_age__Bbl89"> (2-11)
                                                                                        </span>
                                                                            ...
                                                                            <div class="Passengers_row__hDnMI">
                                                                                ...
                                                                                <div class="Passengers_picker__AweCF"><button
                                                                                    ...
                                                                                    <div class="Passengers_description__WNjFy"><span
                                                                                            class="Passengers_name__NRRNi">infants</span><input
                                                                                            type="hidden" class="infants_oneway_trip_serach_page" name="infants" id='infants'
                                                                                            value='0'><span
                                                                                            class="Passengers_age__Bbl89"> (0-1) </span>
                                                                            ...
                                                                            <div class="Passengers_footer__aoTDb"><select
                                                                                    name="cabin_class" class="Passengers_select__57i9p cabin_oneway_trip_search_page">
                                                            ...
                                                            <div class="HorizontalFlightSearch_col__f_ElC"><button
                                                                    class="HorizontalFlightSearch_submit__Pwl4r" id="oneway_trip_search_page" type="submit">Search
                                ...
                                <div class="tab-pane fade" id="pills-contact-mobile" role="tabpanel" aria-labelledby="pills-contact-tab">
                                    <form action="{{route('search-flights-multiple-way')}}" id="multicity_trip_search_submit" method="get">
                                        <input type="hidden" name="numberofFlights" class="numberofFlights" value="2">
                                        <div class="add_flight_mobile">
                
                                        <div class="multicity-trip-error1"></div>
                
                                            <div class="HorizontalFlightSearch HorizontalFlightSearch_inner__v18wS HorizontalFlightSearch_inner--multi__Vjso_">
                                                        ...
                                                        <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0">
                                                            ...
                                                            <div class="Inputs_row__pnlIe Wherefromresult ">
                                                                ...
                                                                <div class="Inputs_col__mZfV_">
                                                                    ...
                                                                    <div class="Inputs_input__value__zMd_E countryname"><span></span>
                                                                    </div>
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwherefrom"
                                                                        placeholder="Where from?" id="multiwherefrom_mobile">
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwhereto"
                                                                        placeholder="Where to?" id="multiwhereto_mobile">
                                                ...
                                                <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date">
                                                    <div>
                                                        <div>
                                                        <input type="text" value="{{date('d/m/Y')}}" name="datetimes3" style=" color: #fff;border: none;line-height: 0;padding: 0;
                                                                height: 0;" class="datetimes3_mobile">
                                                        </div></div>
                
                                                    <div class="HorizontalFlightSearch_col__f_ElC">
                
                                                        <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker3_mobile"
                                                            tabindex="0">
                
                                                            <div class="Inputs_input__placeholder___r5Tt">Date</div>
                
                                                            <div class="Inputs_input__value__zMd_E"><span class="startDate3"
                                                                    id="startDate3">{{date('d/m/Y')}}</span>
                                            ...
                                            <div class="HorizontalFlightSearch HorizontalFlightSearch_inner__v18wS HorizontalFlightSearch_inner--multi__Vjso_">
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwherefrom1"
                                                                        placeholder="Where from?" id="multiwherefrom1_mobile">
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwhereto1"
                                                                        placeholder="Where to?" id="multiwhereto1_mobile">
                                                ...
                                                <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date">
                                                    ...
                                                    <input type="text" name="datetimes4" value="{{date('d/m/Y')}}" style=" color: #fff;border: none;line-height: 0;padding: 0;
                                                            height: 0;" class="datetimes4_mobile">
                                                        </div>
                                                    </div>
                                                    <div class="HorizontalFlightSearch_col__f_ElC">
                
                                                        <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker4_mobile"
                                                            tabindex="0">
                
                                                            <div class="Inputs_input__placeholder___r5Tt">Date</div>
                
                                                            <div class="Inputs_input__value__zMd_E"><span class="startDate4"
                                                                    id="startDate4">{{date('d/m/Y')}}</span>
                                            ...
                                            <div id="hide" class=" HorizontalFlightSearch_inner__v18wS HorizontalFlightSearch_inner--multi__Vjso_">
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwherefrom2"
                                                                        placeholder="Where from?" id="multiwherefrom2_mobile">
                                                        ...
                                                        <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="AirportField_airport-search__X9tnw">
                                                                    ...
                                                                    <input class="Input_input__LYUld AirportField_input__C0fpS multiwhereto2"
                                                                        placeholder="Where to?" id="multiwhereto2_mobile">
                                                ...
                                                <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--dates__iOHJn search-flight-custome-date">
                                                    ...
                                                    <input type="text" name="datetimes5" value="{{date('d/m/Y')}}" style=" color: #fff;border: none;line-height: 0;padding: 0;
                                                            height: 0;" class="datetimes5_mobile">
                                                            </div>
                                                    </div>
                                                    <div class="HorizontalFlightSearch_col__f_ElC">
                
                                                        <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker5_mobile"
                                                            tabindex="0">
                
                                                            <div class="Inputs_input__placeholder___r5Tt">Date</div>
                
                                                            <div class="Inputs_input__value__zMd_E"><span class="startDate5"
                                                                    id="startDate5">{{date('d/m/Y')}}</span>
                                        ...
                                        <div class="HorizontalFlightSearch_inner__v18wS HorizontalFlightSearch_inner--multi__Vjso_">
                                            ...
                                            <div class="HorizontalFlightSearch_row__3maZ1 HorizontalFlightSearch_row--submit__PPu_I">
                                                            ...
                                                            <div class="Passengers_container__GLqfw">
                                                                ...
                                                                <div class="Passengers_row__hDnMI">
                                                                    ...
                                                                    <div class="Passengers_picker__AweCF"><button type="button"
                                                                        ...
                                                                        <div class="Passengers_description__WNjFy"><span
                                                                                class="Passengers_name__NRRNi">adults </span><input
                                                                                type="hidden" name="adults" class="adults_multicity_trip_search_page" id='adults' value='1'><span
                                                                ...
                                                                <div class="Passengers_row__hDnMI">
                                                                    ...
                                                                    <div class="Passengers_picker__AweCF"><button type="button"
                                                                        ...
                                                                        <div class="Passengers_description__WNjFy"><span
                                                                                class="Passengers_name__NRRNi">children</span><input
                                                                                type="hidden" class="children_multicity_trip_search_page" name="children" id='children'
                                                                                value='0'><span class="Passengers_age__Bbl89"> (2-11)
                                                                            </span>
                                                                ...
                                                                <div class="Passengers_row__hDnMI">
                                                                    ...
                                                                    <div class="Passengers_picker__AweCF"><button type="button"
                                                                        ...
                                                                        <div class="Passengers_description__WNjFy"><span
                                                                                class="Passengers_name__NRRNi">infants</span><input
                                                                                type="hidden" class="infants_multicity_trip_search_page" name="infants" id='infants'
                                                                                value='0'><span class="Passengers_age__Bbl89"> (0-1)
                                                                            </span>
                                                                ...
                                                                <div class="Passengers_footer__aoTDb"><select name="cabin_class"
                                                                        class="Passengers_select__57i9p cabin_multicity_trip_search_page">
                                                ...
                                                <div class="HorizontalFlightSearch_col__f_ElC"><button
                                                        class="HorizontalFlightSearch_submit__Pwl4r" id="multicity_trip_search_page" type="submit">Search
                                                ...
                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="AirportField_airport-search__X9tnw">
                                                            ...
                                                            <input class="Input_input__LYUld AirportField_input__C0fpS wherefrom"
                                                                value="@isset($request->wherefrom_shortname){{preg_replace('/\s+/', '',$request->wherefrom_shortname)}}@endisset"
                                                ...
                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="AirportField_airport-search__X9tnw">
                                                            ...
                                                            <input class="Input_input__LYUld AirportField_input__C0fpS whereto"
                                                                value="@isset($request->whereto_shortname){{ preg_replace('/\s+/', '',$request->whereto_shortname)}}@endisset"
                                        ...
                                        <div
                                            ...
                                            <div class="HorizontalFlightSearch_col__f_ElC">
                                                ...
                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker"
                                                    ...
                                                    <div class="Inputs_input__value__zMd_E"><span class="startDate"
                                                            id="startDate">@isset($date[0]){{$date[0]}}@endisset</span>
                                            ...
                                            <div class="HorizontalFlightSearch_col__f_ElC">
                                                ...
                                                <div class="Inputs_input__gSCDv HorizontalFlightSearch_input__FisR0 date_picker"
                                                    ...
                                                    <div class="Inputs_input__value__zMd_E "><span class="endDate"
                                                            id="endDate">@isset($date[1]){{$date[1]}}@endisset</span>
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="Passengers_container__GLqfw">
                                                            ...
                                                            <div class="Passengers_footer__aoTDb"><select
                                                                    ...
                                                                    <option value="Premium_Economy" @if($request->cabin_class == 'Premium_Economy' ) selected
                                                                        @endif>Premium Economy</option>
                                                ...
                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="AirportField_airport-search__X9tnw">
                                                            ...
                                                            <input class="Input_input__LYUld AirportField_input__C0fpS onewaywherefrom"
                                                ...
                                                <div class="modal airport-list Dropdown_dropdown__YFvvQ withModal_dropdown__8cMNJ"
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="AirportField_airport-search__X9tnw">
                                                            ...
                                                            <input class="Input_input__LYUld AirportField_input__C0fpS onewaywhereto"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <center>
                    ...
                    <div>
                        <svg width="50" height="100" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"
                            style="visibility: visible;margin-top: -91px;">
                    ...
                    <div class="owl_theme_img_slider">
                        <div class="owl-carousels owl-theme" id="owl-carousels">
                            <div class="item">
...
@if(isset($request->wherefrom_shortname))
<div class="bar-three bar-con" id="bar-three">
                        ...
                        <div>
                            ...
                            <div class="FlightsLoading_text__VZ2BX">
                                <div class="FlightsLoading_airline__WEtXE">
                                        ...
                                        <span>
                                                with @isset($request->wherefrom){{$request->wherefrom}} @endisset<br /> 
                                                with @isset($request->whereto){{$request->whereto}} @endisset<br />
                                                with @isset($request->wherefrom){{$request->wherefrom}} @endisset<br /> 
                                                with @isset($request->whereto){{$request->whereto}} @endisset<br />
                                                with @isset($request->wherefrom){{$request->wherefrom}} @endisset<br /> 
                                                with @isset($request->whereto){{$request->whereto}} @endisset<br />
...
<script>
    "@if(isset($request->wherefrom_shortname))"
    $(document).ready(function () {
        var url = "{{route('search-flights-details')}}";
        $.ajax({
            url: url,
            data: {
                wherefrom: "{{$request->wherefrom}}",
                wherefrom_shortname: "{{$request->wherefrom_shortname}}",
                whereto: "{{$request->whereto}}",
                whereto_shortname: "{{$request->whereto_shortname}}",
    ...
    $(document).on('click', '.Passengers_done__qJyHR', function () {
        var getcurrentvalue = $(this).closest('.Passengers_container__GLqfw').find('.Passengers_name__NRRNi').html();
        var adultsCurrentValue = $(this).closest('.Passengers_container__GLqfw').find('#' + getcurrentvalue).val();
        var cabin_class = $(this).closest('.Passengers_container__GLqfw').find('[name="cabin_class"]').val();
        var appendValue = adultsCurrentValue + " " + getcurrentvalue + "," + cabin_class + "/Coach";
        $(this).closest('.HorizontalFlightSearch_col__f_ElC').find('.Inputs_input__value__zMd_E span').html(appendValue);
        $('.Dropdown_dropdown__YFvvQ ').hide();
    });


    $(document).on('change', '.air_line_filter_chk', function (e) {
        var cnt = 0;
        $('.result_flights_details').hide().removeClass('count_filter_value');
        $(".air_line_filter_chk:checked").each(function () {
            cnt++;
            if (cnt == 1) { $('.result_flights_details').hide().removeClass('count_filter_value'); }
            //yourArray.push($(this).val());
            var selected_chk_box_airline = $(this).val();

            $('.first_flight_code_' + selected_chk_box_airline).show().addClass('count_filter_value');
            //alert($(this).val());
        });
        if(cnt == 0){
            $('.result_flights_details').show().addClass('count_filter_value') ; 
        }
        var array = $('.count_filter_value').map(function () {
            return $(this).attr('class');
        }).get();
        $('.fiter-count-value').html(array.length);
    });
    $(document).on('click', '.stop_filter_chk', function (e) {
        var cnt = 0;
        $(".stop_filter_chk:checked").each(function () {
            cnt++;
            if (cnt == 1) { $('.result_flights_details').hide().removeClass('count_filter_value'); }
            //yourArray.push($(this).val());
            var selected_chk_box_stop = $(this).val();

            $('.first_flite_stop_' + selected_chk_box_stop + '.second_flite_stop_' + selected_chk_box_stop).show().addClass('count_filter_value');
            //alert($(this).val());
        });
        var array = $('.count_filter_value').map(function () {
            return $(this).attr('class');
    ...
    $(document).on('click', '.airlines_filter_sidebar_chk', function (e) {
        var cnt = 0;
        $('.result_flights_details').hide().removeClass('count_filter_value');
        $(".airlines_filter_sidebar_chk:checked").each(function () {
            cnt++;
            if (cnt == 1) { $('.result_flights_details').hide().removeClass('count_filter_value'); }
            //yourArray.push($(this).val());
            var selected_chk_box_airline = $(this).val();

            $('.second_flight_code_' + selected_chk_box_airline + '.first_flight_code_' + selected_chk_box_airline).show().addClass('count_filter_value');
            //alert($(this).val());
        });
        var array = $('.count_filter_value').map(function () {
            return $(this).attr('class');
    ...
    $(document).on('change', '.allianceResultcheck', function (e) {
        var cnt = 0;
        $('.result_flights_details').hide().removeClass('count_filter_value');
        $(".allianceResultcheck:checked").each(function () {
            cnt++;
            if (cnt == 1) { $('.result_flights_details').hide().removeClass('count_filter_value'); }
            //yourArray.push($(this).val());
            var selected_chk_box_airline = $(this).val();
            $('.first_alliance_code_' + selected_chk_box_airline).show().addClass('count_filter_value');
            // $('.second_alliance_code_' + selected_chk_box_airline + '.first_alliance_code_' + selected_chk_box_airline).show().addClass('count_filter_value');
    ...
    // select flight button click when open pop-modal then submit closest form 
    $(document).on('click','.Result_select-flights__Vl5i8',function(){
        ...
        setTimeout(function() {
         ...
         $(document).on('click','.MobileFilters_item__ImlYl',function(){             
            $("#theModal").modal("show");
             $('.Section_container__gsBYF').hide(); 
             $('.'+$(this).data('modal')).show(); 
             $('.'+$(this).data('modal')).find(".accordion_container .accordion_body").removeAttr('style');
             $('.'+$(this).data('modal')).find(".accordion_container .accordion_head").find(".plusminus").html('<i class="fas fa-angle-down"></i>');
         }); 
...
<script>
    ...
    var currentYear = date.getFullYear();
        ...
        function runDatePicker(datevalue) {
            ...
            $(document).on('keyup','#wherefrom',function(){

                if($(this).val().replace(/\s/g,'') != '')
                {
                    $('.round-trip-error').hide();
                    
                }else{
                    $('.round-trip-error').show();
                }
